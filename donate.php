...
if(isset($_POST['submit'])){
   ...
   $da= $_POST['date'];
 $ph = $_POST['phno'];
    $query1 = "INSERT INTO `donate`( `duser_id`,`d_date`,`d_bgroup`,`d_city`, `d_quantity`,`d_phn`) VALUES ('$i','$da','$bg','$c','$qnt','$ph')";
...
.box {
    ...
    top:10%;
    left:28%;
    background:linear-gradient(rgba(34, 36, 36 , 0.80), rgba(34, 36, 36 , 0.60));
    text-align:left;
    transition: 0.25s;
    margin-top: 80px
        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <form  class="box" action="" method="POST">
                    <ul class="tope"><li>DONATE BLOOD</li>
                   </ul>
...
<br></br>
      <input type="text" name="qunt" placeholder="Enter quantity in ml" required min="0">
	  <br></br>
